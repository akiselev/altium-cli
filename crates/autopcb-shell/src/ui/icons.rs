...
fn draw_icon(p: &Painter, rect: Rect, id: IconId, color: Color32) {
    ...
    match id {
        IconId::Explorer => {
            let r1 = Rect::from_center_size(c + Vec2::new(0.0, -h * 0.15), Vec2::new(w * 0.7, h * 0.45));
            let r2 = Rect::from_center_size(c + Vec2::new(0.0, h * 0.25), Vec2::new(w * 0.7, h * 0.45));
        ...
        IconId::Search => {
            ...
            p.line_segment(
                [c + Vec2::new(w * 0.1, h * 0.1), c + Vec2::new(w * 0.32, h * 0.32)],
                stroke,
            );
        }
        IconId::SourceControl => {
            ...
            p.line_segment(
                [c + Vec2::new(-w * 0.11, -h * 0.14), c + Vec2::new(w * 0.11, -h * 0.05)],
                stroke,
            );
            p.line_segment(
                [c + Vec2::new(-w * 0.11, h * 0.18), c + Vec2::new(w * 0.11, -h * 0.0)],
                stroke,
            );
        }
        IconId::Run => {
        ...
        IconId::Close => {
            p.line_segment(
                [c + Vec2::new(-w * 0.2, -h * 0.2), c + Vec2::new(w * 0.2, h * 0.2)],
                stroke,
            );
            p.line_segment(
                [c + Vec2::new(w * 0.2, -h * 0.2), c + Vec2::new(-w * 0.2, h * 0.2)],
...
pub fn icon_button(
    ...
    if selected {
        ui.painter().rect_filled(rect, 0.0, Color32::from_rgba_unmultiplied(255, 255, 255, 16));
    } else if response.hovered() {
        ui.painter().rect_filled(rect, 0.0, Color32::from_rgba_unmultiplied(255, 255, 255, 12));
    }
