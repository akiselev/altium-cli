...
use crate::traits::{DocumentQuery, HandleFamily};
...
impl PcbLib {
    ...
    pub fn build_footprint(
        ...
        build: impl FnOnce(&mut crate::builders::FootprintBuilder),
    ) -> PcbFootprintHandle {
        let mut builder = crate::builders::FootprintBuilder::new(template);
        build(&mut builder);
...
impl DocumentQuery<crate::handles::PcbFootprint> for PcbLib {
...
mod tests {
    use super::*;
    use crate::backing_store::{BinaryOrigin, ParamOrigin, PcbPrimitiveRef, RecordOrigin};
    ...
    fn pcblib_query_no_match() {
        ...
        let lib = make_test_lib(&["SOT-23"]);
        let result = DocumentQuery::<crate::handles::PcbFootprint>::query(&lib, "NONEXISTENT");
    ...
    fn pcblib_deep_query_pads() {
        ...
        let results = lib
            .query_all_children::<crate::handles::PcbPad>("#2")
            .unwrap();
    ...
    fn pcblib_deep_query_track() {
        let lib = make_lib_with_primitives();
        let results = lib
            .query_all_children::<crate::handles::PcbTrack>("#4")
            .unwrap();
