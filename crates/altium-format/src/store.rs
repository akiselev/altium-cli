...
use crate::backing_store::{PcbPrimitiveRef, RecordNode};
...
pub struct DocumentStore {
    ...
    pub(crate) document_id: Option<crate::semantic_ids::SemanticId>,
    /// Stable semantic IDs for each group (component/footprint).
    pub(crate) group_semantic_ids: HashMap<GroupId, crate::semantic_ids::SemanticId>,
    /// Stable semantic IDs for each record.
    pub(crate) record_semantic_ids: HashMap<RecordId, crate::semantic_ids::SemanticId>,
...
pub enum GroupMeta {
    SchComponent {
        ...
        part_count: i32,
        section_key: String,
        sidecar_streams: crate::documents::schlib_streams::SchLibComponentSidecarStreamsMeta,
    },
    PcbFootprint {
        name: String,
        ...
        raw_header: Vec<u8>,
        sidecar_streams: crate::documents::pcblib_streams::PcbLibFootprintSidecarStreamsMeta,
    },
    SchDocComponent,
}
...
pub enum DocumentMeta {
    SchLib {
        ...
        raw_header_params: Option<crate::parameters::ParameterCollection>,
        section_keys: crate::documents::section_keys::SectionKeyList,
        storage_meta: crate::documents::schdoc_streams::SchDocStorageStreamMeta,
        redirection_streams:
            BTreeMap<String, crate::documents::schlib_streams::SchLibRedirectionStreamMeta>,
    },
    SchDoc {
        file_header_meta: crate::documents::schdoc_streams::SchDocFileHeaderStreamMeta,
        additional_meta: Option<crate::documents::schdoc_streams::SchDocAdditionalStreamMeta>,
        storage_meta: crate::documents::schdoc_streams::SchDocStorageStreamMeta,
    },
    PcbLib {
        section_keys: crate::documents::section_keys::SectionKeyList,
        file_header_meta: crate::documents::pcblib_streams::PcbLibFileHeaderStreamMeta,
        file_version_info_meta: crate::documents::pcblib_streams::PcbLibCountedDataStreamMeta,
        library_meta: crate::documents::pcblib_streams::PcbLibLibraryStorageMeta,
    },
    PcbDoc {
...
impl DocumentStore {
    ...
    pub fn group_semantic_id(&self, id: GroupId) -> Option<&crate::semantic_ids::SemanticId> {
        self.group_semantic_ids.get(&id)
    }

    /// Returns the semantic ID for a record, if computed.
    pub fn record_semantic_id(&self, id: RecordId) -> Option<&crate::semantic_ids::SemanticId> {
