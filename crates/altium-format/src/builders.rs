...
use crate::backing_store::{PcbPrimitiveRef, RecordNode, RecordOrigin};
use crate::records::{
...
mod tests {
    ...
    use crate::newtypes::{Designator, LibReference, PinName};
    use crate::records::SchPinRecord;
    use crate::records::enums::PinElectricalType;
    use crate::templates;
