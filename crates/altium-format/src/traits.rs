...
//! [`crate::coord`] (Track 1A). They are included here with the expectation
...
pub trait HandleFamily {
    ...
    fn try_make_handle(
        store: crate::store::DocRef,
        id: crate::ids::RecordId,
    ...
    fn make_handle(store: crate::store::DocRef, id: crate::ids::RecordId) -> Self::Handle {
