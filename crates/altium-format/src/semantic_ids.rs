...
use crate::store::{DocumentStore, GroupMeta};
...
fn sch_semantic_fingerprint(params: &crate::parameters::ParameterCollection) -> String {
...
mod tests {
    ...
    use crate::store::{DocumentMeta, DocumentStore, GroupData, GroupMeta};
    ...
    fn collision_dup_suffix() {
        let mut store = DocumentStore::new(DocumentMeta::SchLib {
            ...
            section_keys: crate::documents::section_keys::SectionKeyList::new(),
            storage_meta: crate::documents::schdoc_streams::SchDocStorageStreamMeta::default(),
        ...
        for _ in 0..2 {
            ...
            store.insert_group(GroupData {
                ...
                meta: GroupMeta::SchComponent {
                    ...
                    sidecar_streams:
                        crate::documents::schlib_streams::SchLibComponentSidecarStreamsMeta::default(),
                },
            });
        }
    ...
    fn pcb_record_anchor_format() {
        let origin =
            RecordOrigin::Binary(crate::backing_store::BinaryOrigin::new(vec![0xAA; 10]));
    ...
    fn semantic_fingerprint_excludes_volatile() {
        let params1 = crate::parameters::ParameterCollection::from_string(
            "|RECORD=2|NAME=VCC|OWNERINDEX=0|LOCATION.X=100|",
        );
        let params2 = crate::parameters::ParameterCollection::from_string(
