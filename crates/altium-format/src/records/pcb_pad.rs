...
pub(crate) fn parse_pad(data: &[u8]) -> crate::Result<crate::backing_store::RecordOrigin> {
...
#[allow(dead_code)]
fn serialize_pad(origin: &crate::backing_store::BinaryOrigin) -> crate::Result<Vec<u8>> {
