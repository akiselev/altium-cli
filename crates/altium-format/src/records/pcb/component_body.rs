...
//!
//! **DEPRECATED**: Use `v2::pcb::PcbComponentBodyV2` with `v2::pcb::io` instead.
...
///
/// **DEPRECATED**: Use `v2::pcb::PcbComponentBodyV2` instead.
#[deprecated(note = "Use v2::pcb::PcbComponentBodyV2")]
