...
pub(crate) fn parse_via(data: &[u8]) -> crate::Result<crate::backing_store::RecordOrigin> {
...
#[allow(dead_code)]
fn serialize_via(origin: &crate::backing_store::BinaryOrigin) -> crate::Result<Vec<u8>> {
