...
pub(crate) fn parse_text(data: &[u8]) -> crate::Result<crate::backing_store::RecordOrigin> {
...
#[allow(dead_code)]
fn serialize_text(origin: &crate::backing_store::BinaryOrigin) -> crate::Result<Vec<u8>> {
