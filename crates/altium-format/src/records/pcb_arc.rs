...
pub(crate) fn parse_arc(data: &[u8]) -> crate::Result<crate::backing_store::RecordOrigin> {
...
#[allow(dead_code)]
fn serialize_arc(origin: &crate::backing_store::BinaryOrigin) -> crate::Result<Vec<u8>> {
