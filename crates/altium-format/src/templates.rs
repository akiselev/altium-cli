...
use crate::backing_store::{BinaryOrigin, ParamOrigin, RecordOrigin};
...
pub fn pcb_track_default() -> RecordOrigin {
    ...
    data[11] = 0xFF;
    data[12] = 0xFF; // ref5
    crate::records::parse_track(&data)
...
pub fn pcb_arc_default() -> RecordOrigin {
    ...
    data[11] = 0xFF;
    data[12] = 0xFF;
    crate::records::parse_arc(&data).expect("pcb_arc_default must produce a valid AD26 arc origin")
}
...
pub fn pcb_via_default() -> RecordOrigin {
    ...
    data[11] = 0xFF;
    data[12] = 0xFF;
    crate::records::parse_via(&data).expect("pcb_via_default must produce a valid AD26 via origin")
}
...
pub fn pcb_region_default() -> RecordOrigin {
    ...
    crate::records::parse_region(&data)
...
pub fn pcb_component_body_default() -> RecordOrigin {
    ...
    data[11] = 0xFF;
    data[12] = 0xFF;
    crate::records::parse_component_body(&data)
