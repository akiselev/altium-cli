...
use altium_sync::{
    ArtifactKind, ArtifactPatch, ArtifactSnapshot, JournalState, PlanBundle, PlanDirection,
    TransactionJournal, atomic_write_text, default_baseline_path, document_patch, load_baseline,
