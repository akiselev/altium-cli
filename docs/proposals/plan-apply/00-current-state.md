...
today* so the redesign has a faithful baseline. See also the June 2026 spec roundtrip worklog
...
The spec pipeline (per the June 2026 spec roundtrip worklog §2):
